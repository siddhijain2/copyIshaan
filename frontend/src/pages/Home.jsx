...
function Home() {
  return (
    <>
      ...
      <div
        class="container mx-auto my-20 p-4 bg-Tomato rounded-[50px]"
        id="games"
      >
      ...
      <About />
      <div class={`${styles.boxWidth} `} id="team">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6 ">
          <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            ...
            <p class="font-light text-gray-500 sm:text-xl">
              We are final year students studying in IIT BHU Varanasi with an
              inclination towards development.
            </p>
          </div>
          <div class="flex flex-wrap items-stretch -mx-4 justify-center">
