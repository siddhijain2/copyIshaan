...
const Hero = () => {
  return (
    <section id="home" className={`flex md:flex-row flex-col mt-20 sm:py-16 py-3 pr-5`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold xl:text-[92px] ss:text-[72px] text-[42px] text-BlackOlive ss:leading-[100.8px] leading-[75px]">
            Reshaping Accessibilty in<br className="sm:block hidden" />{" "}
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={hero} alt="kids" className="xl:w-[100%] w-[85%] relative z-[5]" />
